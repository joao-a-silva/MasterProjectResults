...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","pvaf/pvaf9" )), 9)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","pvaf/pvaf5" )), 5)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","pvaf/pvaf1" )), 1)
