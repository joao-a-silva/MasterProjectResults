---
title: "Análise Resultados - Uol-non-Electronic"
author: "Joao A. Silva"
output: 
  pdf_document: 
    number_sections: yes
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","nonElectronic/nonElectronic9" )), 9)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","nonElectronic/nonElectronic5" )), 5)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","nonElectronic/nonElectronic1" )), 1)
...
```
```{r, echo=FALSE}
plotTime(subset, "Uol-non-Electronic", 1)
