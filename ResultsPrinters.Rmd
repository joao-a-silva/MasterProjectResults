---
title: "Análise Resultados - Printers"
author: "Joao A. Silva"
output: 
  pdf_document: 
    number_sections: yes
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","printers/printers9" )), 9)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","printers/printers5" )), 5)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","printers/printers1" )), 1)
