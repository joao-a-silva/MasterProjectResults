...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","cora2/cora9" )), 9)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","cora2/cora5" )), 5)
...
```{r, echo=FALSE}
dataFrame <- getDatFrameNameDesambiguation( gsub(" ", "", paste(experimento,"/","cora2/cora1" )), 1)
